...
//    else if([[SDWebImageManager sharedManager] diskImageExistsForURL:imageInfo.imageURL]){
//        _flags.imageIsBeingReadFromDisk = YES;
//        [[SDWebImageManager sharedManager] downloadImageWithURL:imageInfo.imageURL
...
- (void)animateToNext{
    ...
    self.imageView = [[UIImageView alloc] initWithFrame:self.snapshotView.frame];
    self.imageView.layer.cornerRadius = self.imageInfo.referenceCornerRadius;
    self.imageView.contentMode = UIViewContentModeScaleAspectFill;
    self.imageView.userInteractionEnabled = YES;
    self.imageView.isAccessibilityElement = NO;
