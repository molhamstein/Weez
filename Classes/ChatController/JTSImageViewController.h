...
// @AlphaApps removed readonly property
@property (strong, nonatomic) JTSImageInfo *imageInfo;
...
// @AlphaApps removed readonly property
@property (assign, nonatomic) JTSImageViewControllerBackgroundOptions backgroundOptions;
...
// @AlphApps made public to be invoked by subviews
